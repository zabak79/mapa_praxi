...
?>
    ...
    <div class="modal fade" id="map-<?php echo $student['firma_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="mapLabel-<?php echo $student['firma_id'] ?>">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="mapLabel-<?php echo $student['firma_id'] ?>">Lokace studenta</h4>
                </div>
                <div class="modal-body">
                    <p>JA MAM BYT MAPA.</p>
                </div>
